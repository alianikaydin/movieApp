...
public class MovieUpcomingFragment extends BaseFragment implements MoviewUpcomingContract.View {
    private UpcomingListAdapter upcomingListAdapter;

    public static MovieUpcomingFragment getInstance() {
        return new MovieUpcomingFragment();
    }


    @Inject
    MoviewUpcomingContract.Presenter presenter;
    ...
    protected int getContentViewID() {
        return R.layout.fragment_movie_upcoming;
    }
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        upcomingListAdapter = new UpcomingListAdapter(getContext(),this);
        upcomingRecyclerView.setAdapter(upcomingListAdapter);
        presenter.getMovies(page);

        RxRecyclerView.scrollEvents(upcomingRecyclerView)
    ...
    public void setMovieData(List<Result> resultList) {
        upcomingListAdapter.addAll(resultList);
